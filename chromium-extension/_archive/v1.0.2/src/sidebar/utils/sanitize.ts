...
export const formatUiError = (err: unknown, maxChars = 1200) => {
  ...
  if (normalized.includes("bridge_token_missing")) {
    ...
    text =
      "Bridge unreachable. Ensure SOCA Bridge is running and Base URL is correct (default http://127.0.0.1:9834/v1).";
  } else if (
    ...
    text =
      "Provider disabled. Use SOCA Bridge or enable 'Allow direct providers' in Settings.";
