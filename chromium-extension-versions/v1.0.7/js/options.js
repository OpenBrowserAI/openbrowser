/******/ (() => {
  ...
  \************************/
      /***/ (
        ...
        const OPENAI_COMPAT_PROVIDER = (id, name, api) => ({
          id,
          name,
          npm: "@ai-sdk/openai-compatible",
          api,
        ...
        async function fetchModelsData(options) {
          ...
          try {
            ...
            for (const descriptor of descriptors) {
              ...
              const normalizedProvider = String(descriptor.provider || "")
                .trim()
                .toLowerCase();
              if (
                normalizedProvider === OPENROUTER_PROVIDER_ID ||
            ...
            const data = {
              ...
              openrouter: {
                ...DIRECT_PROVIDER_CATALOG.openrouter,
                models: {
                  ...DIRECT_PROVIDER_CATALOG.openrouter.models,
                  ...openrouterModels
                }
              }
            };
  ...
  \*******************************/
      /***/ (
        ...
        const BRIDGE_ROUTED_PROVIDER_IDS = new Set([
          "soca-bridge",
          "openrouter"
        ]);
        ...
        const OptionsPage = () => {
          ...
          (0, react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
            ...
            const loadModels = async () => {
              try {
                ...
                Object.entries(imageProviders).forEach(
                  ([providerId, provider]) => {
            ...
            const loadSavedConfig = async () => {
              ...
              if (!configLoaded) {
                ...
                if (result.llmConfig) {
                  ...
                  if (
                    !result.llmConfig.npm &&
                    providersData[result.llmConfig.llm]
                  ) {
                    result.llmConfig.npm =
                      providersData[result.llmConfig.llm].npm;
                  }
                  if (
                    !result.llmConfig.modelName ||
                    !((_b = modelOptions[result.llmConfig.llm]) === null ||
                    _b === void 0
                      ? void 0
                      : _b.some((m) => m.value === result.llmConfig.modelName))
                  ) {
                    result.llmConfig.modelName =
                      ((_d =
                        (_c = modelOptions[result.llmConfig.llm]) === null ||
                        _c === void 0
                          ? void 0
                          : _c[0]) === null || _d === void 0
                        ? void 0
                  ...
                  if (
                    !((_e = result.llmConfig.options) === null || _e === void 0
                      ? void 0
                      : _e.baseURL)
                  ) {
                    result.llmConfig.options = {
                      ...
                      _llm_llm__WEBPACK_IMPORTED_MODULE_14__.getDefaultBaseURL)(
                        ...
                        (_f = providersData[result.llmConfig.llm]) === null ||
                          _f === void 0
                          ? void 0
                          : _f.api
                      )
                  ...
                  if (
                    ...
                    !isLocalBaseURL(
                      String(
                        ((_h = result.llmConfig.options) === null ||
                        _h === void 0
                          ? void 0
                          : _h.baseURL) || ""
                      )
                ...
                try {
                  ...
                  const selectedProvider = String(
                    ((_j = result.llmConfig) === null || _j === void 0
                      ? void 0
                      : _j.llm) || ""
                  );
                  if (
              ...
              if (
                config.modelName &&
                !((_k = modelOptions[config.llm]) === null || _k === void 0
                  ? void 0
                  : _k.some((m) => m.value === config.modelName))
              ) {
                const nextModel =
                  ((_m =
                    (_l = modelOptions[config.llm]) === null || _l === void 0
                      ? void 0
                      : _l[0]) === null || _m === void 0
                    ? void 0
                    : _m.value) || "";
          ...
          const handleSave = () => {
            (async () => {
              ...
              try {
                ...
                if (
                  BRIDGE_ROUTED_PROVIDER_IDS.has(
                    String(llmConfigValue.llm || "")
                  )
                ) {
          ...
          const handleBridgeCheck = async () => {
            ...
            const summarizeBridgeStatus = (payload) => {
              const openrouterKeyPresent = Boolean(
                payload === null || payload === void 0
                  ? void 0
                  : payload.openrouter_key_present
              );
              const openrouterCount = Number(
                (payload === null || payload === void 0
                  ? void 0
                  : payload.openrouter_models_count) || 0
              );
              const mergedCount = Number(
                (payload === null || payload === void 0
                  ? void 0
                  : payload.merged_models_count) || 0
              );
            ...
            try {
              ...
              if (!formToken) {
                try {
                  const runtimeStatus = await runtimeSendMessage({
                    type: "SOCA_BRIDGE_GET_STATUS"
                  });
                  if (
                    (runtimeStatus === null || runtimeStatus === void 0
                      ? void 0
                      : runtimeStatus.ok) &&
                    (runtimeStatus === null || runtimeStatus === void 0
                      ? void 0
          ...
          const requiresApiKey =
            bridgeRoutedProvider || (isDirectProvider && !openaiCompatLocal);
                  ...
                  directProviderBlocked &&
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
                      antd__WEBPACK_IMPORTED_MODULE_2__["default"],
                      {
                        ...
                        description:
                          "Switch provider policy mode to 'All providers' above to use this provider."
                      }
                    ),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
                      ...
                      !bridgeStatus.message &&
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
                          ...
                          "Click \u201CCheck Bridge\u201D to verify the local SOCA Bridge endpoint used by ",
